...
> **처방 상태(2026-09-19 같은 날)**: 칸 1 의 ①~⑥ 은 닫혔다 — ① 06484c2 · ②③ 87ef041 · ④ fefd4f1 · ⑤ 071064d · ⑥ 뒤따르는 커밋.
> 관문 421 → 433, 주입 8/8 적발. 남은 것은 ⑦(발행자 확인: C3 법규 · D7 법규 · D1 PII)과 칸 2·3 이다.
> 처방 중 드러난 것: C1 의 마지막 소비자는 화면(/judge 가 `i['price']` 렌더)이었고 관문이 그것을 3 failed 로 잡았다.
